        ...
        <van-tabs :active="page">
            ...
            <van-tab title="注册">
                <van-form @submit="registerSubmit">
                    <van-cell-group inset>
                        <van-field name="username" v-model="register.username" required label="请输入昵称" placeholder="请输入昵称" :rules="[{ validator: usernameValidator, message: '用户名1-10字符' }]" />
                        <van-field name="password" v-model="register.password" required type="password" label="密码" placeholder="密码" :rules="[{ validator: passwordValidator, message: '密码8-16字符' }]" />
                        <van-field name="passwordACK" v-model="register.passwordACK" required type="password" label="确认密码" placeholder="确认密码" :rules="[{ validator: passwordValidator, message: '密码8-16字符' }]" />
